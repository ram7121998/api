...
export const addressVerification = async (req, res) => {
    try {
        ...
        const { doc, country, state, city, address1, address2, zip, } = req.body;
        ...
        tx = await prisma.$transaction(async (tx) => {
            ...
            const notification = await tx.notifications.create({
                data: {
                    ...
                    message: "You have successfully added your address details. It will verify in sometime. Please wait.",
