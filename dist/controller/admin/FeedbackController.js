...
export const getFeedback = async (req, res) => {
    try {
        ...
        const starRating = totalReactions > 0
        ...
        // ==============================
        const requiredFeedback = await Promise.all(feedbackRows.map(async (data) => {
            let fromUser = null;
            let fromAdmin = null;
            let trade = null;
            // feedback_from = user
            ...
            const sender = data.feedback_from === "admin" ? fromAdmin : fromUser;
            return {
                feedback: {
                ...
                feedbackFrom: data.feedback_from === "admin"
                    ? adminDetails(sender)
        ...
        const pagination = {
            ...
            next_page_url: page < Math.ceil(totalFilteredFeedback / perPage)
