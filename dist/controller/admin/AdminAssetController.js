...
export const createAdminAsset = async (req, res) => {
    try {
        ...
        const { asset, network, blockchain, wallet_address, wallet_key, contract_address, withdrawal_fee_type, withdrawal_fee, withdrawal_type, conversion_fee_type, conversion_fee, } = req.body;
        // 1️⃣ Validate Blockchain + Network + Asset combinations
        const isValidCombo = (blockchain === "ethereum" &&
            network === "erc20" &&
...
export const updateAdminAssets = async (req, res) => {
    try {
        ...
        const { admin_asset_id, contract_address, withdrawal_fee_type, withdrawal_fee, withdrawal_type, status, conversion_fee_type, conversion_fee } = req.body;
        ...
        const hasAtLeastOneField = Object.values(updatableFields).some((value) => value !== undefined && value !== null && value !== "");
