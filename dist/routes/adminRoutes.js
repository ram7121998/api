...
// Admin Register
router.post("/admin/auth/register", formData, [
...
], authenticateAdmin, registerAdmin);
router.put("/admin/auth/updateAdmin", formData, [
    ...
    body("role")
        .isIn(["admin", "sub_admin"])
        .withMessage("Role must be admin or sub_admin"),
], authenticateAdmin, updateAdmin);
// Admin Login
router.post("/admin/auth/login", formData, [
